    ...
    class KitsuneLuaCore {
        public:
            ...
            void runKitsuneCore() {
                ...
                "package.path = EXEC_DIR .. '/data/lua/?.lua;' .. package.path\n"
                "package.path = EXEC_DIR .. '/data/lua/?/init.lua;' .. package.path\n"
                "local kitsuneCore = require('KitsuneCore')\n"
                "kitsuneCore.Initialize()\n"
                "kitsuneCore.Run()\n"
                "end, function(e)\n"
